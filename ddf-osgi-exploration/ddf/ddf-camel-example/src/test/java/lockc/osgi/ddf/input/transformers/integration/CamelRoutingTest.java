...
public class CamelRoutingTest {
    ...
    public Option[] config() throws Exception {
        ...
        return new Option[] {
                ...
                mavenBundle("lockc.osgi.ddf.examples", "ddf-camel-example", "1.0-SNAPSHOT")
        };
        //@formatter:on
    }
    ...
    public void testBundleActive() throws Exception {
        ...
        Bundle b = getBundle(bundleContext, "lockc.osgi.ddf.camel.ddf-camel-example");
