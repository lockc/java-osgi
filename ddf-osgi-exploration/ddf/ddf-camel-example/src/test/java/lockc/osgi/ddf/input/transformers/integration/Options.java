...
//                debugConfiguration(),
                ...
                features(maven("org.apache.camel.karaf", "apache-camel", "2.14.0"), 
                            "camel-blueprint", "camel-jms", "camel-http4", "camel-test"),
                            
                features(maven("org.apache.activemq", "activemq-karaf", "5.11.1"), 
                            "activemq-camel", "activemq-blueprint")                            
    ...
    public static Option configureConfigurationPorts() throws URISyntaxException {
        ...
        return composite(
                ...
                replaceConfigurationFile(
                        ...
                        new File(Options.class.getResource("/org.ops4j.pax.url.mvn.cfg").toURI())),
